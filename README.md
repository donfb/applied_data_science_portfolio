...
Aan het einde van deze pagina is een evaluatie van wat ik dit project gedaan en geleerd heb.
...
De hyperparameters voor een genetisch algoritme zijn niet zo belangrijk als bij neurale netwerken. Je hebt best wat speling en zonder de optimale waardes kom je er vaak ook. Ik heb er tuurlijk wel wat tijd aan besteed. Hierover is meer te lezen in het hoofdstuk Genetisch algoritme.
